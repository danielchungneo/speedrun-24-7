...
const Buttons = () => {
  ...
  return (
    <Block paddingHorizontal={sizes.padding}>
      ...
      <Modal visible={showModal} onClose={() => setModal(false)}>
        <FlatList
...
const Inputs = () => {
  ...
  return (
    ...
    >
      ...
      <Block>
        <TextField placeholder="Regular" marginBottom={sizes.sm} />
        <TextField placeholder="Search" marginBottom={sizes.sm} />
        <TextField
          search
          label="Search"
          marginBottom={sizes.sm}
        ...
        />
        <TextField success placeholder="Success" marginBottom={sizes.sm} />
        <TextField danger placeholder="Error" marginBottom={sizes.sm} />
        <TextField disabled placeholder="Disabled" marginBottom={sizes.sm} />
      </Block>
    </Block>
  );
};
...
export default CTComponentsScreen;
