...
import Product from '@/components/Demo/CT/Product';

const CTRentalScreen = () => {
    ...
    >
      ...
      <Block paddingHorizontal={sizes.sm} marginTop={sizes.sm}>
        <Button
          ...
          onPress={() =>
            navigation.navigate(screens.CT_BOOKING, { optionId: optionId })
          }
        >
