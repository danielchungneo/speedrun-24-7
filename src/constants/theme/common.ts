...
export const ASSETS: ThemeAssets = {
  ...
  AudioWideRegular: require('@/assets/fonts/Audiowide-Regular.ttf'),
...
export const ANIMATIONS: ThemeAnimations = {
  webTools: require('@/assets/animations/web-design-tools.json'),
  appBuild: require('@/assets/animations/app-build.json'),
};
...
export const FONTS: ThemeFonts = {
  ...
  s1: 'OpenSans-SemiBold',
  s2: 'OpenSans-SemiBold',
  s3: 'OpenSans-SemiBold',
  s4: 'OpenSans-SemiBold',
  s5: 'OpenSans-SemiBold',
  s6: 'OpenSans-SemiBold',
  i1: 'OpenSans-SemiBold',
  i2: 'OpenSans-SemiBold',
  p: 'OpenSans-Regular',
