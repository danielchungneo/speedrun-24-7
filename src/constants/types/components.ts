...
export interface IBlockProps
  ...
  gray?: boolean;
  /**
   * Renders a backgroundColor directly from the colors.darkGray value
   * @see https://reactnative.dev/docs/view-style-props#backgroundcolor
   */
  darkGray?: boolean;
  /**
...
export interface ITextProps extends TextProps, ISpacing {
  ...
  tertiary?: boolean;
  /**
   * Renders a Text color directly from the colors.text value of the alternative theme
   */
  alternative?: boolean;
  /**
  ...
  gray?: boolean;
  /**
   * Renders a Text color directly from the colors.darkGray value
   * @see https://reactnative.dev/docs/text-style-props#color
   */
  darkGray?: boolean;
  /**
