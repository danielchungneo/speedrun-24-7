...
export interface ITheme {
  ...
  assets: ICommonTheme['assets'];
  animations: ICommonTheme['animations'];
  icons: ICommonTheme['icons'];
  fonts: ICommonTheme['fonts'];
  weights: ICommonTheme['weights'];
  lines: ICommonTheme['lines'];
  styles: ICommonTheme['styles'];
}
...
type LottieType = string | AnimationObject | { uri: string };
