...
import { IColorVariant, IFontSizeVariant } from './components/common';
...
export interface IBlockProps
  ...
  keyboard?: boolean;
  /**
   * Renders a KeyboardAvoidingView component
   */
  ...
  /**
   * Renders a backgroundColor directly from the theme
...
export interface ICheckboxProps extends ISpacing {
  ...
  /**
   * Renders a disabled / non-clickable checkbox
   */
  disabled?: boolean;
}
...
export interface IInputProps extends TextInputProps, ISpacing {
  ...
  id?: string;
  /**
   * Renders a borderColor and placeholderTextColor directly from the theme
   * @see https://reactnative.dev/docs/view-style-props#backgroundcolor
   */
  variant?: IColorVariant;
  /**
  ...
  iconSize?: number;
  /**
   * Changes the placement of the icon
   */
  ...
  /**
   * Renders the component wrapper with custom style
   */
  componentWrapperStyle?: TextStyle | TextStyle[] | object[];
  /**
   * Renders the component input wrapper (everything minus the label) with custom style
   */
  inputWrapperStyle?: TextStyle | TextStyle[] | object[];
  /**
   * Changes the keyboard and onChange logic
   */
  type?: 'number' | 'decimal' | 'text' | 'textarea' | 'password';
  /**
   * Changes how value label is formatted (does not change the internal value)
   */
  format?: 'commas';
}
...
export interface IModalProps {
  ...
  /**
   * Hides the close button in the top right corner (handle close via another button)
   */
  hideCloseButton?: boolean;
  /**
   * Sets the color of the backdrop when the modal becomes visible
   */
  backdropColor?: string;
  /**
   * Sets the blur intensity of the backdrop when the modal becomes visible
   */
  backdropBlur?: number;
  /**
   * How to view the modal (bottomsheet or dialog)
   */
  viewMode?: 'dialog' | 'bottom-sheet';
  /**
   * Determines animation type when modal becomes visible
   */
  animationType?: 'none' | 'slide' | 'fade';
  /**
   * Color of the content Block
   */
  ...
  /**
   * Determining if the modal should close when the user taps outside of the modal content
   */
  allowBackdropPress?: boolean;
  /**
   * Determine if the modal should avoid keyboard
   */
  keyboardView?: boolean;
}
...
export interface ISwitchProps extends ISpacing {
  ...
  /**
   * Props to pass to the Pressable container
   */
  pressableProps?: PressableProps;
  /**
   * Renders a disabled / non-clickable switch
   */
  disabled?: boolean;
}
...
export interface ITextProps extends TextProps, ISpacing {
  ...
  gradient?: string[];
  /**
   * Renders a text color directly from the theme
   * @see https://reactnative.dev/docs/view-style-props#backgroundcolor
   */
  variant?: IColorVariant;
  /**
  ...
  /**
   * Renders a Text with fontSize from theme or custom value
   * @see https://reactnative.dev/docs/text-style-props#fontsize
   */
  size?: IFontSizeVariant | number;
  /**
